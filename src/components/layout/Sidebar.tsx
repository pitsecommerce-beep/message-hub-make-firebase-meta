...
const navItems: NavItem[] = [
  ...
  { label: 'Configuración', path: '/settings', icon: <Settings size={20} />, roles: ['admin', 'manager'] },
  { label: 'Administración', path: '/admin', icon: <Shield size={20} />, roles: ['admin'] },
];
  ...
  return (
    <aside
      className={classNames(
        'h-screen bg-white border-r border-surface-200 flex flex-col transition-all duration-200 sticky top-0',
        collapsed ? 'w-16' : 'w-60'
      )}
    >
      {/* Logo */}
